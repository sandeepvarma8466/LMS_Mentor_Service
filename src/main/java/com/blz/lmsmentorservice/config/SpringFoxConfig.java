package com.blz.lmsmentorservice.config;
...
public class SpringFoxConfig implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.blz.lmsmentorservice.controller"))
                .paths(PathSelectors.any())
                .build()
                .apiInfo(apiInfo());
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("AdminService",
                "APIs for E.",
                "1.0",
                "Terms of service",
                new Contact("AdminService", "http://bridgelabz.lms", "svarma852@gmail.com"),
                "Apache 2.0",
